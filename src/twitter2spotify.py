...
def creatPlayList():  # Build profile and create playlist
    ...
    if tweets:
        token = spotify_login.prompt('playlist-modify-private', '7e6e5c11bb82461c9b12578a301e1cec',
...
enterButton = Tkinter.Button(app, text="Enter", width=7, bg="#81b71a", fg="#ffffff", command=creatPlayList,
                             font=("Times", 16))
enterButton.pack()
